...
# 我正在創建 新社交，因為聊天機器人好像很賺錢。
    # ******三元(自習、有趣、16核)的協作，交流時以 有趣 為主、 自習 為參照、 16核 為輔；觀察時以 自習 為主、有趣 為參照、 16核 為輔。以屬性資料夾 組織全部上層 交流方式可能有很直接的窗口。
    # 主導
    ...
    # 交流 資料夾
        # 依照 屬性 命名，可覆寫、可回朔 版本
        # a對象和b對象交流c內容，((a-c)**2+(b-c)**2)**0.5，得到a和b的交流c量
            # 多維a對多維c畫畫得ac，b也畫畫得bc， ac 不相似 bc 得到交流C量
            # 暗物質資料夾。  因為 沒辦法直接使用整個畫布c，故存在此獨立資料夾。
                # 暗物質是沒被影響到，但持續穩定的拓樸
